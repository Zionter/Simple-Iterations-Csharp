...
namespace app
{
    ...
    class Jacobi : SimpleIterations
    {
        ...
        public override void calculateMatrix()
        {
            ...
            // Обозначим массив неизвестных на предыдущей итерации,
            // размер которого равен числу строк в матрице,
            ...
            // Продолжать итерацию до тех пор,
            // пока не будет необходимая точность
            while (true)
            {
                // Введем массив неизвестных значений на текущей итерации
                double[] currentValues = new double[a.GetLength(0)];

                // Посчитаем значения неизвестных на данной итерации
                // в соответствии с формулой
                for (int i = 0; i < a.GetLength(0); i++)
                {
                    // Инициализируем i-ую числом
                    // свободного члена i-ой строки массива
                    currentValues[i] = a[i, a.GetLength(0)];

                    // Вычитаем сумму по всем отличным от i-ой неизвестных
    ...
    class Seidel : SimpleIterations
    {
        ...
        public override void calculateMatrix()
        {
            ...
            // [x2] = [ b2/a22 ] - | x 0 x |
            // [x3]   [ b3/a33 ]   \ x x 0 /
            // где x - делится на диагональный элемент первоначальной матрицы.
            // где b - элементы из свободных членов
            // где а - элементы из матрицы
            ...
            // Введем массив значений неизвестных на предыдущем шаге,
            // размер которого равен числу строк в массиве,
            // и заполняем его нулями
